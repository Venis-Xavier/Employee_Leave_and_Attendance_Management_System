...
const EmployeeDashboard = ({ setLoggedIn }) => {
  ...
  return (
    <div className="container-fluid bg-light py-5 d-flex justify-content-center align-items-center min-vh-100">
      <div className="container">
        <h2 className="mb-4 text-center">Attendance Dashboard</h2>
        <div className="row justify-content-center">
          <div className="col-md-8 col-lg-6">
            {error && <div className="alert alert-danger mb-3">{error}</div>}
            {success && <div className="alert alert-success mb-3">{success}</div>}
 
            <form onSubmit={submitAttendance} className="bg-white rounded shadow p-5">
